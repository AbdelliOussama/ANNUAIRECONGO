...
public static class CompanyErrors
{
    ...
    public static Error CompanyFollowNotFound(Guid id) => Error.NotFound(
        "CompanyFollow.NotFound",
        $"Company follow with id '{id}' was not found.");
    ...
    public static Error InvalidCreditorCompanyId => Error.Validation(
        "Company.InvalidCreditorCompanyId",
        "The provided creditor company ID is invalid.");
    public static Error InvalidDebtorIdentifier => Error.Validation(
        "Company.InvalidDebtorIdentifier",
        "The provided debtor identifier is invalid.");
    public static Error InvalidAmount => Error.Validation(
        "Company.InvalidAmount",
        "The provided amount is invalid.");
    public static Error InvalidCurrency => Error.Validation(
        "Company.InvalidCurrency",
