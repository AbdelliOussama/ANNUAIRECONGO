...
public static class PlanSeeder
{
    public static async Task SeedPlansAsync(AppDbContext context)
    {
        ...
        var plans = new[]
        {
            Plan.Create(PlanName.Free,      0,      365, 3,  1,  false, false, 3).Value,
            Plan.Create(PlanName.Pro,   5000,      30, 5,  2,  false, false, 2).Value,
            Plan.Create(PlanName.Premium, 15000,     30, 15, 5,  true,  true,  1).Value,
        };
