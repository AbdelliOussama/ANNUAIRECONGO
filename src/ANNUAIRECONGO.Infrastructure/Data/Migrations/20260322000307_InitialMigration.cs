        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyPosition = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactClicks = table.Column<int>(type: "int", nullable: false),
                    SearchAppearances = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnalyticsDailySummaries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AnalyticsDailySummaries_Companies_CompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CompanyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ReporterIp = table.Column<string>(type: "nvarchar(45)", maxLength: 45, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompanyReports_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContactClicks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ContactClicks_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvoiceUrl = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnalyticsDailySummaries_CompanyId_SummaryDate",
                table: "AnalyticsDailySummaries",
                columns: new[] { "CompanyId", "SummaryDate" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyDocuments_UploadedAt",
                table: "CompanyDocuments",
                column: "UploadedAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyReports_CompanyId",
                table: "CompanyReports",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyReports_CreatedAt",
                table: "CompanyReports",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyReports_Status",
                table: "CompanyReports",
                column: "Status");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactClicks_CompanyId_ClickedAt",
                table: "ContactClicks",
                columns: new[] { "CompanyId", "ClickedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfileViews_CompanyId_ViewedAt",
                table: "ProfileViews",
