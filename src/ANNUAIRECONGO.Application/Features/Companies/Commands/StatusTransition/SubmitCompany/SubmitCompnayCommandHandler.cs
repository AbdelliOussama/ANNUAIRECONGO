...
public sealed record SubmitCompanyCommandHandler(ILogger<SubmitCompanyCommandHandler> logger, IAppDbContext context, HybridCache cache) : IRequestHandler<SubmitCompanyCommand, Result<Updated>>
{
