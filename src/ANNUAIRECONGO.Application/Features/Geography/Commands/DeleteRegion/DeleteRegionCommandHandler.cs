...
public sealed record DeleteRegionCommandHandler(IAppDbContext Context, ILogger<DeleteRegionCommandHandler> logger) : IRequestHandler<DeleteRegionCommand, Result<Deleted>>
{
