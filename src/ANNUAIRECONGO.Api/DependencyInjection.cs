...
using ANNUAIRECONGO.Api.Infrastructure;
using ANNUAIRECONGO.Api.OpenApi.Transformers;
using ANNUAIRECONGO.Api.Services;
...
public static class DependencyInjection
{
    ...
    public static IServiceCollection AddApiDocumentation(this IServiceCollection services)
    {
        ...
        foreach (var version in versions)
        {
            services.AddOpenApi(version, options =>
            {
                ...
                // Security Scheme config — both document and operation transformers still registered separately
    ...
    public static IApplicationBuilder UseCoreMiddlewares(this IApplicationBuilder app, IConfiguration configuration)
    {
        ...
        // 10. Prometheus metrics scraping endpoint (requires AddPrometheusExporter in AddAppOpenTelememrty)
        // NOTE: Cast to IEndpointRouteBuilder if using WebApplication, or call this in Program.cs:
